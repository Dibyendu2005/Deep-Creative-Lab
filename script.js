// JavaScript Document
        ...
        const imageData = [
            {
                title: "Food Ordering App (MERN)",
                description: "Full-stack food delivery system with Stripe integration"
            },
            {
                title: "Pothole Detection System",
                description: "YOLOv5 + Python based road safety detection model"
            },
            {
                title: "E-Commerce Website",
                description: "React + Node + MongoDB complete online store"
            },
            {
                title: "Resume Shortlisting AI",
                description: "NLP + Machine Learning resume filtering system"
            },
            {
                title: "Internet Speed Test App",
                description: "Dashboard UI with live graph & CSV export"
            },
            {
                title: "Rock Paper Scissors Game",
                description: "2-player game with sound effects & animations"
            },
            {
                title: "My Startup Ideas",
                description: "Creative tech concepts and problem-solving products"
            }
        ];
